    ...
    >
      <div className="flex justify-between items-start">
        ...
        <div className="text-right">
          <h2 className="text-2xl font-bold uppercase text-slate-300">
            INVOICE
          </h2>
          ...
          <div className="inline-block min-w-full py-2 align-middle">
            <table className="min-w-full">
              <thead className="bg-blue-50">
                <tr>
                  <th className="py-2 px-3 text-left text-xs font-semibold text-blue-700">
                    Item
                  </th>
                  <th className="py-2 px-3 text-right text-xs font-semibold text-blue-700">
                    Amount
                  </th>
                </tr>
              </thead>
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        <div>
          <h3 className="font-semibold text-green-600 border-b border-green-200 pb-1">
            Earnings
          </h3>
        ...
        <div>
          <h3 className="font-semibold text-red-600 border-b border-red-200 pb-1">
            Deductions
          </h3>
          <div className="flex justify-between text-sm mt-2">
            <span>Tax</span>
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <div className="p-2 bg-slate-100 rounded text-lg font-bold">
            $50.00
          </div>
        </div>
        <div>
  ...
  const features = [
    {
      ...
      description:
        "Our tools are 100% free, with no watermarks, no ads, and no 'premium' features held back. Get full access instantly.",
      icon: RiShieldCheckLine,
    },
    {
      name: "No Sign-up Required",
      description:
        "We don't need your email or password. Just land on the page and start working. Your data is your own.",
      icon: RiUserSearchLine,
    },
    {
      name: "Premium & Professional",
      description:
        "Choose from multiple modern templates, add your logo, and download a print-ready PDF that impresses clients.",
      icon: RiLayoutLine,
    },
  ];
...
function AllToolsSection() {
  const tools = [
    ...
    },
    {
      ...
      description:
        "Visualize monthly payments and total interest for any loan.",
