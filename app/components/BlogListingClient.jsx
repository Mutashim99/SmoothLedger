"use client"; // UPDATED: This is now a Client Component

import React from "react";
import { motion } from "framer-motion";
import Link from "next/link";
// import { allBlogs } from "../../blogsdata"; // UPDATED: This is no longer needed
import { RiArrowRightSLine, RiPriceTag3Line } from "react-icons/ri";

export default function BlogListingClient({ blogs }) { // UPDATED: Renamed and accepts 'blogs' as a prop
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog, i) => ( // UPDATED: uses 'blogs' prop
              <motion.div
                key={blog.slug}
